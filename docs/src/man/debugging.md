...
The first two are GPUCompiler's macros, re-exported: cuTile reports its
...
Like their CUDA.jl counterparts, `@device_code_typed` returns a dictionary
...
job is printed once per macro invocation. Hooks are scoped to the current task
